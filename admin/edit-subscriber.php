...
<div>
    <form action="mailing-list.php" method="post">
        ...
        <input type="text" id="name" name="name" value="<?=$subscriber->getName();?>" required>

        <label for="email">Email</label>
        <input type="email" id="email" name="email" value="<?=$subscriber->getEmail();?>" required>

        <label for="phone">Телефон</label>
        <input type="text" id="phone" name="phone" value="<?=$subscriber->getPhone();?>" required>

        <label for="message">Сообщение</label>
        <input type="text" id="message" name="message" value="<?=$subscriber->getMessage();?>" required>
